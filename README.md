...
**Apr 13** — `hannah-portfolio`: Add Tinker Flywheel — research memo on the iteration gap
...
**Apr 13** — `hannah-portfolio`: Fix job card URL overflow + make legacy notes editable
...
**Apr 12** — `hannah-portfolio`: Note entries: editable inline + X to delete
**Apr 12** — `hannah-portfolio`: Fix SYNC_SECRET trim in job-digest route
...
**Apr 06** — `interior-designer-portfolio`: fix: crop tool auto-zooms and numbered list prefix applies to wrong line
